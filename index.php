        ...
        <div class="container">
            ...
            <div class="affiliate-offers">
                <div class="affiliate-card fade-in">
                    ...
                    <a href="https://www.amazon.com.au" class="btn btn-rainbow">Join Now</a>
                </div>
                <div class="affiliate-card fade-in">
                    <div class="card-header">
                        <div class="affiliate-icon">
                    ...
                    <div class="card-stats">
                        <span class="stat">20% Commission</span>
                        <span class="stat">Monthly Payouts</span>
                    </div>
                    <a href="https://www.shopify.co.nz/" class="btn btn-rainbow">Learn More</a>
                </div>
                <div class="affiliate-card fade-in">
                    <div class="card-header">
                        <div class="affiliate-icon">
                ...
                <div class="affiliate-card fade-in">
                    ...
                    <h3>Dell Affiliate</h3>
                    <p>Earn commissions on NZ's largest online marketplace.</p>
                    <div class="card-stats">
                        <span class="stat">Up to 3% Commission</span>
                        <span class="stat">Local NZ Focus</span>
                    </div>
                    <a href="https://slice.digital/offer/dell-nz-affiliate-program" class="btn btn-rainbow">Start Now</a>
                </div>
                <div class="affiliate-card fade-in">
                    <div class="card-header">
                        <div class="affiliate-icon">
                        ...
                        <div class="card-badge">Vietnam</div>
                    </div>
                    <h3>Lazada Affiliate</h3>
                    <p>Promote products in Vietnam's leading e-commerce platform.</p>
                    <div class="card-stats">
                        <span class="stat">Up to 10% Commission</span>
                        <span class="stat">Vietnam Market</span>
                    </div>
                    <a href="https://pages.lazada.vn/wow/i/vn/corp/affiliate-partner?hybrid=1" class="btn btn-rainbow">Partner Up</a>
                </div>
            </div>
        </div>
    </section>
          ...
          <section class="partners-section">
               <div class="container">
                   ...
                   <div class="partners-grid">
                        ...
                        <div class="partner-logo">
                            <img src="images/logo2.png" alt="Trade Me" style="width: 150px; height: 80px;" onerror="this.src='https://via.placeholder.com/150x80/2874F0/FFFFFF?text=Trade Me'">
                        </div>
                        <div class="partner-logo">
                            <img src="images/logo3.png" alt="Lazada Vietnam" style="width: 150px; height: 80px;" onerror="this.src='https://via.placeholder.com/150x80/FF3F6C/FFFFFF?text=Lazada Vietnam'">
                        </div>
                        <div class="partner-logo">
